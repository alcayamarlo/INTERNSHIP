...
<style>
    ...
    .student-page-shell .table thead th {
        ...
        border-color: rgba(117,176,215,.16);
        font-size: 0.72rem;
...
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="student-page-title">My Competencies</h1>
            <p class="student-page-subtitle">Earned skills backed by assessments, certificates, or verified training</p>
        </div>
