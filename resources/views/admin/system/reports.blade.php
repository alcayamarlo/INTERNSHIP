...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Generate platform-wide reports and backups</p>
    </div>
    <form action="{{ route('admin.backup') }}" method="POST">
        @csrf
        <button type="submit" class="btn btn-outline-danger"><i class="bi bi-database-down"></i> Database Backup</button>
    </form>
</div>
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead class="table-light"><tr><th>Type</th><th>Format</th><th>Generated By</th><th>Date</th></tr></thead>
                    <tbody>
